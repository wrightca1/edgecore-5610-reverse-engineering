...
class AcctonAS5712_54XSwitch(cumulus.platform.BCMSwitch):
    ...
    ports = (
        ...
        _qsfp(label="50", serdes=(104, 105, 106, 107), leds=(1, 43, 22, 23, 24, 25)),
        _qsfp(label="51", serdes=(100, 101, 102, 103), leds=(1, 44, 26, 27, 28, 29)),
        _qsfp(label="52", serdes=(108, 109, 110, 111), leds=(1, 42, 30, 31, 32, 33)),
        _qsfp(label="53", serdes=(80, 81, 82, 83),     leds=(1, 46, 34, 35, 36, 37)),
